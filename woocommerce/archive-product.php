...
<div class="arhiver-subcategory pt-md-3">
  <ul class="products-category-list-archive"></ul>
  ...
  <div class="container-fluid archive-head-filters-and-sort mb-3">
  <div class="row mt-3">
    <div class="col-12 pr-0">
      <button class="open-filters">Фильтры товаров</button>
