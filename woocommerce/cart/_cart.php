...
<div class="sidecart-items row">
            ...
            <div class="product-thumbnail col-12">
              ...
              ?>
						...
						<div class="product-name col-10" data-title="<?php esc_attr_e( 'Product', 'woocommerce' ); ?>">
						<?php
						if ( ! $product_permalink ) {
						...
						<div class="product-remove col-2 text-right">
							<?php
            ...
            <div class="product-price col-6" data-title="<?php esc_attr_e( 'Price', 'woocommerce' ); ?>">
							<?php
